...
(cl:defmethod cl:initialize-instance :after ((m <pose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'pose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exercise-msg:<pose> is deprecated: use exercise-msg:pose instead.")))
...
(cl:defmethod z-val ((m <pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exercise-msg:z-val is deprecated.  Use exercise-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'alpha-val :lambda-list '(m))
(cl:defmethod alpha-val ((m <pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exercise-msg:alpha-val is deprecated.  Use exercise-msg:alpha instead.")
  (alpha m))

(cl:ensure-generic-function 'beta-val :lambda-list '(m))
(cl:defmethod beta-val ((m <pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exercise-msg:beta-val is deprecated.  Use exercise-msg:beta instead.")
  (beta m))

(cl:ensure-generic-function 'gamma-val :lambda-list '(m))
(cl:defmethod gamma-val ((m <pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exercise-msg:gamma-val is deprecated.  Use exercise-msg:gamma instead.")
  (gamma m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<pose>)))
  ...
  "dbadb174d44d322fcf4d588e4c2d44a5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'pose)))
  "Returns md5sum for a message object of type 'pose"
  "dbadb174d44d322fcf4d588e4c2d44a5")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<pose>)))
  ...
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%float64 alpha~%float64 beta~%float64 gamma~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'pose)))
  "Returns full string definition for message of type 'pose"
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%float64 alpha~%float64 beta~%float64 gamma~%~%"))
